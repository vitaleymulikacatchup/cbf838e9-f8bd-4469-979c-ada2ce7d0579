...
export const metadata: Metadata = {
  title: "Luxe Hotel - Premium 5-Star Luxury Accommodations",
  description: "Experience world-class hospitality at our luxury hotel resort. Book your stay with premium rooms, fine dining, spa services, and exceptional service.",
  keywords: ["luxury hotel", "resort", "accommodations", "fine dining", "spa wellness"],
  openGraph: {
    title: "Luxe Hotel - Premium 5-Star Luxury Accommodations",
    description: "Experience world-class hospitality at our luxury hotel resort",
    siteName: "Luxe Hotel",
    type: "website"
  }
};
